  ...
  return (
    <section className="py-20 bg-background-light dark:bg-background-dark relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-primary font-bold tracking-widest text-sm mb-2">COMMUNITY & NEWS</h2>
          <h3 className="text-3xl md:text-4xl font-display font-bold text-secondary dark:text-white mb-4">부동산 팁 & 단지 소식</h3>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">고덕그라시움외 고덕동, 상일동 일대의 관련 최신 부동산 소식과 소유주를 위한 유용한 콘텐츠를 확인하세요.</p>
        </motion.div>
        <motion.div
